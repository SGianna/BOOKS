...
### 궁금한 내용
- FitNesse : 오픈소스테스트 도구
- JUnit : 웹 기반 테스트 프레임 워크
- TO문단 : LOGO언어에서 사용하는 키워드 'TO'는 루비나 파이썬에서 사용하는 'def'와 똑같다. LOGO에서 모든 함수는 키워드 'TO'로 시작한다. 
- SRP(Single Responsibility Principle), OCP (Open Closed Principle)
- 추상화 팩토리 
- [도메인 특화 언어](https://www.jetbrains.com/ko-kr/mps/concepts/domain-specific-languages/) (DSL,Domain-Specific Languages) <-> 범용 언어(GPL,General-purpose programming language)
